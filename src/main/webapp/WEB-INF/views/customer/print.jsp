...
<title>新增客户界面设计</title>
    ...
    $(function () {
		...
		myLayout.cells("b").setWidth(200);
		 ...
		 myToolbar.format({
		        Items: [
		            { ID: "print", Type: "button", Text: "打印",Img: "print.gif"},	
		            { ID: "sep1", Type: "separator" },
		            { ID: "design", Type: "button", Text: "页面设计",Img: "build.png" },	
		        ...
		        Action: function (id) {
		        	if (id == "print") {
		            	//打印区域的内容
		            	//var printContents = document.getElementById('seeBox').innerHTML;
		            	//页面的所有内容
...
<div id = "see" style = "width:100%;height:100%;overflow: auto;background:#E0E0E0;">
	<div id ="seeBox" style="width:88%;height:2500px;margin-left:5%;margin-top:2.5%;margin-bottom:2.5%;box-shadow: 0 0 6px #a0a0a0;"></div>
</div>
</body>
</html>