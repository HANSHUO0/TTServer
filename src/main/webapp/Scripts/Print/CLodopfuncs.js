(function (win) {
    var CLODOP = {
        strWebPageID: "G9Pft18",
        strTaskID: "",
        strHostURI: "http://169.254.155.205:8000",
        VERSION: "6.2.1.7",
        IVERSION: "6217",
        CVERSION: "2.1.0.2",
        HTTPS_STATUS: 0,
        ...
        Printers: {
            ...
            },
            {
                ...
                {
                    "name": "复写 3 1/3 x 4 英寸"
                },
                {
                    "name": "复写 7 4/5 x 4 5/7 英寸"
                },
                {
                    "name": "LodopCustomPage"
                },
                ...
                {
                    "name": "102 x 152 mm (4 x 6 in)"
                },
                {
                    "name": "89 x 127 mm (3.5 x 5 in)"
                },
                {
                    "name": "Postcard 100 x 148 mm"
                }]
            },
            {
                "name": "\\\\192.168.2.158\\DPK750-USB",
                "DriverName": "DPK750-USB",
                "PortName": "USB001",
                "Orientation": "1",
                "PaperSize": "9",
                "PaperLength": "2970",
            ...
            {
                "name": "\\\\192.168.2.98\\Brother MFC-7340 Printer",
                "DriverName": "Brother MFC-7340 Printer",
                "PortName": "USB001",
                "Orientation": "1",
                "PaperSize": "9",
                "PaperLength": "2970",
                ...
                "DCOrientation": "90",
                "MaxExtentWidth": "2159",
                "MaxExtentLength": "4064",
                "MinExtentWidth": "762",
                "MinExtentlength": "1160",
                "pagelist": [{
                    "name": "A4"
                },
                {
        ...
        OpenWebSocket: function () {
            ...
            try {
                if (!this.webskt || this.webskt.readyState == 3) {
                    ...
                    this.webskt = new WebSocket('ws://169.254.155.205:8000/c_webskt/');
