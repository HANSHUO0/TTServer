(function($, window) {
  ...
  var opts = {
    //表情库列表
    "emoLib": [{
      "path": "/Chat/expression/arclist/", //表情文件路径
      "postfix": "gif",   //表情文件后缀
      "number": 75        //表情包总数
    }],
    "input": "#send_txt",    //输入框
  ...
  var imgs = '<img src="{{path}}{{num}}.{{postfix}}" onclick="$.insertEncode({{num}})" />';
  ...
  $.insertEncode = function(num) {
    ...
    var send = document.getElementById("send_txt");
    var img = document.createElement('img');
    img.src = emo.path+num+"."+emo.postfix;
